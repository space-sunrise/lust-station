...
/// <summary>
/// Hands of cards (fanned out) and the pick-a-card UI.
/// </summary>

public sealed class CardHandSystem : EntitySystem
{
    [ValidatePrototypeId<EntityPrototype>]
    public readonly EntProtoId CardHandBaseName = "LustCardHandBase";
    [ValidatePrototypeId<EntityPrototype>]
    public readonly EntProtoId CardDeckBaseName = "LustCardDeckBase";
