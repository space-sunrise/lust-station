...
delivery-spam-2 =   Reasons to choose Qillu!
    .desc =         An advertisement for Qillu.
...
delivery-spam-5 =   FREE ALL AXCESS!!
    ...
    .content =      [head=3]Have You ever wanted to have [italic][color=green]Free [bold]All Axcess!?!?[/bold][/color][/italic][/head]
                    ...
                    {"[color=gray]"}
                    {"[bullet/]Note: station ID must be stated in the format of \"Qillu/NX - ###\""}
...
delivery-spam-7 =   Send reinforcements!
    ...
    .content =      {-delivery-header-nanotrasen-alternate-timeline}
                    {"[head=2]This is an official notice from the [color=red]Chief Security Officer[/color] at a Qillu's Space Station 15.[/head]"}
...
delivery-spam-12 =  Join us on the maiden voyage!
    ...
    .content =      [head=2]Join us on the maiden voyage of the...[/head]
                    ...
                    {"[head=3]Explore the ruins of Agathar***, now open to the public with the assistance of Qillu's top Scientists. All the mysteries of the old Agatharian civilization are excavated and displayed for your viewing pleasure![/head]"}
