...
ent-PlushieTwentyTwo = Kondrat Seran
    .desc = Legend has it that the red-haired Seran has successfully completed many cases and closed his lawyer's office because of the new Qillu decree. He lives in a dark corner, weaving silk thread, and he's sneaking in here to build a new house.
