...
ent-ClothingOuterCoatSecurityOvercoat = security overcoat
    .desc = Lightly armored leather overcoat meant as casual wear for high-ranking officers. Bears the crest of Qillu Security.
...
ent-ClothingOuterCoatNtrep = nt representive jacket
    .desc = A fancy black jacket, standart issue to Qillu Representives.
