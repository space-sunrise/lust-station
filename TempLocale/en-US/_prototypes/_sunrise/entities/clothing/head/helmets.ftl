...
ent-ClothingHeadEVAHelmetERTLeader = ERT leader EVA helmet
    .desc = An in-atmosphere helmet worn by the leader of a Qillu Emergency Response Team.
ent-ClothingHeadEVAHelmetERTChaplain = ERT chaplain EVA helmet
    .desc = An in-atmosphere helmet worn by the chaplain of a Qillu Emergency Response Team.
ent-ClothingHeadEVAHelmetERTSecurity = ERT security EVA helmet
    .desc = An in-atmosphere helmet worn by security members of the Qillu Emergency Response Team.
ent-ClothingHeadEVAHelmetERTMedic = ERT medic EVA helmet
    .desc = An in-atmosphere helmet worn by medical members of the Qillu Emergency Response Team.
ent-ClothingHeadEVAHelmetERTEngineer = ERT engineer EVA helmet
    .desc = An in-atmosphere helmet worn by engineering members of the Qillu Emergency Response Team.
ent-ClothingHeadEVAHelmetERTJanitor = ERT janitor EVA helmet
    .desc = An in-atmosphere helmet worn by janitorial members of the Qillu Emergency Response Team.
