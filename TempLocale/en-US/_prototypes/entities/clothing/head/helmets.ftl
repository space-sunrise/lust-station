...
ent-ClothingHeadHelmetSwat = SWAT helmet
    .desc = An extremely robust helmet, commonly used by paramilitary forces. This one has the Qillu logo emblazoned on the top.
...
ent-ClothingHeadHelmetERTLeader = ERT leader helmet
    .desc = An in-atmosphere helmet worn by the leader of a Qillu Emergency Response Team. Has blue highlights.
ent-ClothingHeadHelmetERTSecurity = ERT security helmet
    .desc = An in-atmosphere helmet worn by security members of the Qillu Emergency Response Team. Has red highlights.
ent-ClothingHeadHelmetERTMedic = ERT medic helmet
    .desc = An in-atmosphere helmet worn by medical members of the Qillu Emergency Response Team. Has white highlights.
ent-ClothingHeadHelmetERTEngineer = ERT engineer helmet
    .desc = An in-atmosphere helmet worn by engineering members of the Qillu Emergency Response Team. Has orange highlights.
ent-ClothingHeadHelmetERTJanitor = ERT janitor helmet
    .desc = An in-atmosphere helmet worn by janitorial members of the Qillu Emergency Response Team. Has dark purple highlights.
