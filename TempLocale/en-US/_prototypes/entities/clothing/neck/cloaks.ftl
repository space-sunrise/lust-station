...
ent-ClothingNeckCloakAce = pilot's cloak
    .desc = Cloak awarded to Qillu's finest space aces.
...
ent-ClothingNeckCloakAroace = aeropilot's cloak
    .desc = Cloak awarded to Qillu's finest pilots on planets with inhabitable atmospheres.
...
ent-ClothingNeckCloakGay = multi-level marketing cloak
    .desc = This cloak is highly sought after in the Qillu Marketing Offices.
