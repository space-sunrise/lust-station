...
ent-ClothingUniformJumpsuitRepairmanSyndie = syndicate repairman jumpsuit
    .desc = Functional, fashionable, and badass. Qillu's engineers wish they could look as good as this.
ent-ClothingUniformJumpsuitParamedicNT = paramedic jumpsuit
    .desc = A basic white & blue jumpsuit made for Qillu paramedics stationed in combat sectors.
