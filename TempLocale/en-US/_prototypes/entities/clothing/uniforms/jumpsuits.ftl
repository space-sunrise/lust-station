...
ent-ClothingUniformJumpsuitSecGrey = grey security jumpsuit
    .desc = A tactical relic of years past before Qillu decided it was cheaper to dye the suits red instead of washing out the blood.
ent-ClothingUniformSecurityTrooper = trooper uniform
    .desc = A formal uniform issued to the Qillu Troopers, usually it comes with a car.
ent-ClothingUniformJumpsuitWarden = warden's uniform
    .desc = A formal security suit for officers complete with Qillu belt buckle.
