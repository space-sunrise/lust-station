...
ent-PosterContrabandMissingGloves = Missing Gloves
    .desc = This poster references the uproar that followed Qillu's financial cuts toward insulated-glove purchases.
ent-PosterContrabandHackingGuide = Hacking Guide
    .desc = This poster details the internal workings of the common Qillu airlock. Sadly, it appears out of date.
ent-PosterContrabandRIPBadger = RIP Badger
    .desc = This seditious poster references Qillu's genocide of a space station full of badgers.
...
ent-PosterContrabandPower = Power
    .desc = A poster that positions the seat of power outside Qillu.
...
ent-PosterContrabandRebelsUnite = Rebels Unite
    .desc = A poster urging the viewer to rebel against Qillu.
...
ent-PosterLegitNanotrasenLogo = Qillu Logo
    .desc = A poster depicting the Qillu logo.
...
ent-PosterLegit50thAnniversaryVintageReprint = 50th Anniversary Vintage Reprint
    .desc = A reprint of a poster from 2505, commemorating the 50th Anniversary of Nanoposters Manufacturing, a subsidiary of Qillu.
ent-PosterLegitFruitBowl = Fruit Bowl
    .desc = Simple, yet awe-inspiring.
ent-PosterLegitPDAAd = PDA Ad
    .desc = A poster advertising the latest PDA from Qillu suppliers.
ent-PosterLegitEnlist = Enlist
    .desc = Enlist in the Qillu Deathsquadron reserves today!
...
ent-PosterLegitNoERP = No ERP
    .desc = This poster reminds the crew that Eroticism and Pornography are banned on Qillu stations.
...
ent-PosterLegitThereIsNoGasGiant = There Is No Gas Giant
    .desc = Qillu has issued posters, like this one, to all stations reminding them that rumours of a gas giant are false.
...
ent-PosterLegitVacation = Qillu Corporate Perks: Vacation
    .desc = This informational poster provides information on some of the prizes available via the Qillu Corporate Perks program, including a two-week vacation for two on the resort world Idyllus.
...
ent-PosterLegitRenault = Renault Poster
    .desc = Yap.
ent-PosterLegitNTTGC = Qillu Tactical Game Cards
    .desc = An advertisement for Qillu's TCG cards: BUY MORE CARDS.
