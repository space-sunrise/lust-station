...
ent-SignHead = head sign
    .desc = An official sign indicating the dwellings of a Qillu-certified head of department.
...
ent-SignZomlab = zombie lab sign
    .desc = The final remains of a shut-down Qillu research project that aimed to harness the powers of Romerol. I wonder how that went...
