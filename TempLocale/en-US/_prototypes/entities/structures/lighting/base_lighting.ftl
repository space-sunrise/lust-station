...
ent-EmergencyLight = emergency light
    .desc = A small light with an internal battery that turns on as soon as it stops receiving any power. Qillu technology allows it to adapt its color to alert crew to the conditions of the station.
