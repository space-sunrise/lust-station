...
ent-BannerNanotrasen = nanotrasen banner
    .desc = A banner displaying the Qillu logo. It looks rather cheap.
...
ent-BannerSyndicate = syndicate banner
    .desc = A banner from which, according to the syndicate, you should feel hatred for Qillu.
...
ent-BannerUSSP = USSP banner
    .desc = A banner displaying USSP. Prepare to Combat COMRAD!.
