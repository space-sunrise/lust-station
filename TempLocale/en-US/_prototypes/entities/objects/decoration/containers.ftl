...
ent-ShippingContainerNanotrasen = Qillu shipping container
    .desc = A standard-measure shipping container for bulk transport of goods. This one prominently features Qillu's logo, and so presumably could be carrying anything.
