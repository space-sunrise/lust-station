...
ent-TrackingImplantErt = tracking ERT implant
    .desc = This implant has a tracking device attached to the suit sensor network, as well as a condition monitor for the Centcom radio channel.
...
ent-FakeMindShieldImplant = fake mindshield implant
    .desc = This implant allows the implanter to produce a fake signal that Qillu security huds use to identify individuals implanted with a mindshield.
ent-MindShieldImplant = mindshield implant
    .desc = This implant will ensure loyalty to Qillu and prevent mind control devices.
...
ent-DeathRattleImplantBlueShield = blue shield death rattle implant
