...
ent-BookEngineersHandbook = engineer's handbook
    .desc = A handbook about engineering written by Qillu.
ent-BookScientistsGuidebook = scientist's guidebook
    .desc = A guidebook about science written by Qillu.
ent-BookSecurity = security 101
    .desc = A book about security written by Qillu. The book is stained with blood. It seems to have been used more as a weapon than reading material.
...
ent-BookSpaceLaw = space law
    .desc = A set of Qillu guidelines for keeping law and order on their space stations.
