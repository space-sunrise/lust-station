...
ent-WeaponLaserCarbine = laser rifle
    .desc = Favoured by Qillu Security for being cheap and easy to use.
ent-WeaponPulsePistol = pulse pistol
    .desc = A state of the art energy pistol favoured as a sidearm by the Qillu operatives.
ent-WeaponPulseCarbine = pulse carbine
    .desc = A high tech energy carbine favoured by the Qillu-ERT operatives.
