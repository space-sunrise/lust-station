...
ent-WeaponPistolMk58 = mk 58
    .desc = Designed by Qillu’s Small Arms Division, the Mk58 is a conventional semi-automatic pistol with a simple recoil-operated action and excellent reliability. The standard sidearm of Qillu’s station security and emergency response teams. Feeds from .35 pistol magazines.
ent-WeaponPistolN1984 = N1984
    .desc = An exceptionally powerful ‘hand cannon’ designed as part of Qillu's BFG initiative. Chambered in .45, the lord’s caliber, it is generally considered too unwieldy for standard use but has become something of a status symbol among Qillu officials. Feeds from .45 pistol magazines.
