...
ent-MechVim = Vim
    .desc = A miniature exosuit from Qillu, developed to let the irreplaceable station pets live a little longer.
...
ent-MechNTGygax = Qillu Special Gygax
    .desc = Qillu's trump card when solving problems. High durability, increased protection against shock, explosions, temperature, shots: conventional, laser and energy, as well as expanded equipment slots allow to turn the situation on the station upside down. Gas pedals consume a colossal amount of energy.
