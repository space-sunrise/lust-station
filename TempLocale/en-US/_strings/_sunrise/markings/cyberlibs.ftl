...
# Qillu
marking-CyberlimbRArmNanotrasen = Протез, правая рука (Qillu)
marking-CyberlimbLArmNanotrasen = Протез, левая рука (Qillu)
marking-CyberlimbRHandNanotrasen = Протез, кисть правой руки (Qillu)
marking-CyberlimbLHandNanotrasen = Протез, кисть левой руки (Qillu)
marking-CyberlimbRLegNanotrasen = Протез, правая нога (Qillu)
marking-CyberlimbLLegNanotrasen = Протез, левая нога (Qillu)
marking-CyberlimbRFootNanotrasen = Протез, правая стопа (Qillu)
marking-CyberlimbLFootNanotrasen = Протез, левая стопа (Qillu)
marking-CyberlimbTorsoNanotrasen = Протез, туловище (Qillu)
# Xion
