...
ent-PosterContrabandRealExomorph = Настоящий! Экзоморф
...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как Qillu сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов Qillu. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном Qillu на космической станции, полной барсуков.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами Qillu.
...
ent-PosterContrabandRebelsUnite = Бунтари вместе
    .desc = Плакат, призывающий читателя восстать против Qillu.
...
ent-PosterContrabandRouny = Вы его видели?
    .desc = Старый плакат о пропавшем инопланетянине. Куда он сбежал?
...
ent-PosterContrabandShamblersJuice = Сок Шамблер
    .desc = ~Взболтайте мне немного этого сока Шамблера!~
...
ent-PosterContrabandExoAcid = Предупреждение об экзоморфах: Кислотный плевок!
    .desc = Этот плакат предупреждает вас о кислотном плевке экзоморфа. Не то чтобы такие экзоморфы были реальны... Верно?
ent-PosterContrabandExoRun = Предупреждение об экзоморфах: Убегайте!
...
ent-PosterContrabandExoChomp = Предупреждение об экзоморфах: Опасные укусы!
    .desc = Этот плакат предупреждает вас о смертельных укусах, которые могут быть у экзоморфов. Не становитесь закуской для пришельцев!
ent-PosterLegitHereForYourSafety = Здесь для вашей безопасности
    .desc = Плакат, восхваляющий службу безопасности станции.
ent-PosterLegitNanotrasenLogo = Логотип Qillu
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвящённого 50-летию компании Nanoposters Manufacturing, дочерней компании Qillu.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков Qillu.
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти Qillu сегодня!
...
ent-PosterLegitNoERP = Скажи "НЕТ" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография запрещены на станциях "Qillu".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = Qillu распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
...
ent-PosterLegitVacation = Корпоративные привилегии Qillu: Отпуск
...
ent-PosterLegitRenault = Постер с Алисой
    .desc = Йап.
ent-PosterLegitNTTGC = Тактическая карточная игра Qillu
    .desc = Реклама новой ТКИ от Qillu: ПОКУПАЙТЕ БОЛЬШЕ КАРТОЧЕК.
ent-PosterLegitSafetyMothSSD = Мотылек безопасности - расстройство космического сна
    .desc = Этот информационный плакат с использованием Safety Moth™ рассказывает зрителям о расстройстве космического сна (SSD) - состоянии, при котором человек перестает реагировать на происходящее. "Относитесь к экипажу с SSD с осторожностью! Они могут проснуться в любой момент!"
ent-PosterLegitOppenhopper = Оппенхоппер
    .desc = Плакат к давно забытому фильму. Он рассказывает о группе упорных новичков из Сектора Кузнечиков, которые защищаются от нападений печально известных Ядерных Оперативников. Слоган гласит: "Ядерные Операции продолжатся, пока робастность не улучшится."
ent-PosterLegitTyrone = Руководство Тайрона по космосу
    .desc = Плакат, рекламирующий онлайн-обучение космосу. Перечисленные занятия, кажется, охватывают всё: от базового использования станционного оборудования до сложных тем, таких как создание самодельных бомб или покрытие целых коридоров космической смазкой. Дисклеймер гласит: "Это никогда не бывает ТАК плохо, и в конце вы, возможно, даже получите тортилью."
