...
ent-ClothingHandsKnuckleDustersBrass = латунный кастет
    .desc = Латунный кастет, сделан так же, как и раньше, и бьет так же сильно.
ent-ClothingHandsKnuckleDustersQM = золотой кастет квартирмейстера
    .desc = 24-каратное золото, сплавленное с пласталью и отмеченное логотипом Qillu. Истинный символ могущества квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = синдикатский кастет
    .desc = Пластитановый кастет с кроваво-красной меткой S. Настоящий мужчина убивает им.
ent-ClothingHandsKnuckleDustersStun = оглушающий кастет
    .desc = Пара кастетов, объединенных с технологией оглушающей дубинки. Это значительно облегчает избиение тидеров.
ent-ClothingHandsKnuckleBoneCrushers = костедробилки
