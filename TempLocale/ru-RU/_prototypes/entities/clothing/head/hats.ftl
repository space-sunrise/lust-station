...
ent-ClothingHeadHatSecurityTrooper = шляпа солдата
    .desc = Кампанская шляпа для солдатов Qillu. Изначально была с футляром, но вы его потеряли.
...
ent-ClothingHeadHatCanadaBeanie = шапка-бини
    .desc = Красная, белая и уютная. От нее веет домашним уютом, если ваш дом, конечно, не холодный и полон кофеен.
...
ent-ClothingHeadWehcellentCap = превосходная кепка
    .desc = Это была сетчатая кепка! Тайдеры носят их постоянно! У неё есть вентиляционные отверстия сзади для сквозняка и всё такое!
...
ent-ClothingHeadHatSolidHeadband = сплошная повязка на голову
