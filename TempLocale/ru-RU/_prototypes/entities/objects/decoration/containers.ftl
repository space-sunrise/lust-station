...
ent-ShippingContainerNanotrasen = грузовой контейнер Qillu
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображён логотип компании Qillu, и поэтому внутри может быть что угодно.
