...
ent-WeaponLaserCarbine = лазерная винтовка
    .desc = Предпочитается службой безопасности Qillu за дешевизну и простоту использования.
    .suffix = Винтовка
ent-WeaponPulsePistol = импульсный пистолет
    .desc = Новейший энергетический пистолет, предпочитаемый оперативниками Qillu в качестве запасного оружия.
    .suffix = Пистолет
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники ОБР Qillu.
    .suffix = Винтовка
