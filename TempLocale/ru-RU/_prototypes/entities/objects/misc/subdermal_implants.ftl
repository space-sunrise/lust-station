...
ent-TrackingImplantErt = имплант Предсмертный хрип ОБР
    .desc = Этот имплант сообщит в радиоканал Центркома, если пользователь окажется в критическом состоянии или умрёт.
...
ent-FakeMindShieldImplant = имплант Поддельный ментальный щит
    .desc = Этот имплант позволяет имплантатору создавать ложный сигнал, который используется ИЛС службы безопасности Qillu для идентификации лиц с имплантированным ментальным щитом.
ent-MindShieldImplant = имплант Щит разума
    .desc = Этот имплант гарантирует лояльность корпорации Qillu и предотвращает воздействие устройств контроля сознания.
ent-RadioImplantCentcomm = Радиоимплант Центркома
    .desc = Этот имплант предоставляет доступ к каналу Центркома без гарнитуры. Разрешён только для сотрудников Центркома.
...
ent-DeathRattleImplantCentcomm = имплант предсмертного хрипа Центркома
    .desc = Этот имплант сообщит на радиоканал Центркома, если пользователь попадет в критическое состояние или умрет.
