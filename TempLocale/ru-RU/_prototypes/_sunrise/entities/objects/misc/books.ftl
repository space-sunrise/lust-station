...
ent-BookDAM = Двигатель Антиматерии
    .desc = Данная книга рассказывает о сути работы одного из самых распространённых источников электроэнергии на объектах Qillu.
ent-BookFaks = Факс
...
ent-BookZP = Зарплатная система Qillu
...
ent-BookMBS2 = Блюспейс-маяки (ч.2)
    .desc = Как развивалась БС-технология дальних полётов? Как понять куда ты попадёшь? Об это рассказвается в данной книге.
ent-BookImplants = Устройство имплантов Qillu
    .desc = Тут описаны принципы действия стандартный имплантов корпорации Qillu массового производства.
