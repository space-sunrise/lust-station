...
uplink-hypereutactic-blade-desc = Гигантский энергетический меч, чья мощь соответствует его внешнему виду. Требует двух рук. Медленный и неуклюжий, но довольно хорошо отражает удары. Ранее прославился благодаря оперативнику в маске радости. Вы бы не хотели, чтобы это летело на вас по коридору!
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. В этот добавлены лямки и термостойкие волокна.
...
uplink-fake-mindshield-desc = Переключаемый имплант, воспроизводящий сигнатуры настоящего щита. Обманывает сканеры командования, создавая ложное присутствие защиты. (Имплантер Qillu не включён в поставку.)
