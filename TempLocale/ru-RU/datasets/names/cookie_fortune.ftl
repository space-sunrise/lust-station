...
descriptions-cookie-fortune-dataset-47 = Qillu заставляет меня писать эти драные записки для печенек, пожалуйста помогите!
...
descriptions-cookie-fortune-dataset-77 = А вы знали, что более 70% сотрудников Qillu исчезают в первые пару лет своего контракта? Теперь знаете!
