...
public sealed partial class HumanoidProfileEditor
{
    ...
    private void UpdateSexControls()
    {
        ...
        else
        {
            ...
            SetSex(sexes[0]); // Lust edit - синхронизируем профиль с доступным полом
        }
    }
    ...
    public void RefreshSpecies()
    {
        ...
        _species.AddRange(GetSunriseAvailableSpecies()); // Sunrise-Edit — фильтрация спонсорских видов
    ...
    private void SetSpecies(string newSpecies)
    {
        ...
        UpdateSunriseControls(); // Sunrise-Edit — обновление телосложения и голоса для нового вида
    ...
    private void SetSex(Sex newSex)
    {
        ...
        UpdateSunriseControls(); // Sunrise-Edit — обновление телосложения и голоса для нового пола
        ReloadPreview();
    }
