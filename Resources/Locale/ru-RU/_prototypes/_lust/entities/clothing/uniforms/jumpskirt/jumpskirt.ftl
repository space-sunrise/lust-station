...
ent-ClothingUniformJumpskirtCentcomSkirtSuitQillu = юбка-костюм Центкома
    .suffix = Qillu
    .desc = Парадная форма ЦентКома по контракту Qillu. Элегантная, строгая и подчинённая протоколу - даже складки на юбке строятся по команде.
