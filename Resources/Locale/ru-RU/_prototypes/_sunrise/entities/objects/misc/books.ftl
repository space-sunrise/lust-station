...
ent-BookZP = Зарплатная система Nanotrasen
...
ent-BookMBS2 = Блюспейс-маяки (ч.2)
    .desc = Как развивалась БС-технология дальних полётов? Как понять куда ты попадёшь? Об это рассказвается в данной книге.
ent-BookImplants = Устройство имплантов Nanotrasen
    .desc = Тут описаны принципы действия стандартный имплантов корпорации Nanotrasen массового производства.
