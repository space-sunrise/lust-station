...
ent-BannerNanotrasen = знамя Qillu
    .desc = Это знамя с логотипом Qillu. Оно выглядит довольно дёшево.
...
ent-BannerSyndicate = знамя Синдиката
    .desc = Знамя, из-за которого по мнению синдиката, вы должны возненавидеть QL.
...
ent-BannerUSSP = знамя СССП
    .desc = Вставай Красный Защитник! За Родину!.
