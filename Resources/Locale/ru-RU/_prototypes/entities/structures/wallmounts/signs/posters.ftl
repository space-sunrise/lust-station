...
ent-PosterLegitNoERP = Скажи "ДА" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография разрешены на станциях "Qillu".
...
ent-PosterLegitVacation = Корпоративные привилегии Qillu: Отпуск
    .desc = На этом информационном плакате представлена информация о некоторых призах, которые можно получить в рамках программы 'Корпоративные привилегии QL', включая двухнедельный отпуск на двоих на планете-курорте Идиллус.
