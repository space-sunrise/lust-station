...
ent-MechVim = ВИМ
    .desc = Миниатюрный экзокостюм компании Qillu, разработанный для того, чтобы позволить незаменимым питомцам станции прожить немного дольше.
...
ent-MechNTGygax = Особый гигакс Qillu
    .desc = Козырь Qillu при решении проблем. Высокая прочность, повышенная защита от ударов, взрывов, температуры, выстрелов: обычных, лазерных и энергетических, а также расширенные слоты под оборудование позволяют перевернуть ситуацию на станции. Ускорители потребляют колоссальное количество энергии.
