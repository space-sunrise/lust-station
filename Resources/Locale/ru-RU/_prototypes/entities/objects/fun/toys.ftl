...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч - один из самых популярных продуктов компании Qillu. 'Почему мы делаем пляжные мячи? Потому что мы можем! (TM)' - Qillu.
...
ent-BalloonNT = воздушный шарик Qillu
