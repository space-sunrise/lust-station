...
ent-ClothingBackpackCaptain = рюкзак капитана
    .desc = Это особый рюкзак, изготавливаемый исключительно для офицеров Qillu.
...
ent-ClothingBackpackCluwne = трясушкин фон трясхертон
    ...
    .suffix = Неснимаемый
ent-ClothingBackpackElectropack = электрошокер
    .desc = Ударяет током по сигналу. Используется для удержания особо опасного преступника под контролем.
    .suffix = Самонеснимаемый
ent-ClothingBackpackDebug = рюкзак
    .desc = Что это за чертовщина?
    .suffix = ДЕБАГ
