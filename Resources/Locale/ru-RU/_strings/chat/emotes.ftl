...
chat-emote-name-thump = Вилять хвостом
chat-emote-name-click = Клацать
chat-emote-name-clap = Хлопать
chat-emote-name-clap-single = Один хлопок
...
chat-emote-name-snarl = Оскалиться
...
chat-emote-msg-thump = виляет { POSS-ADJ($entity) } хвостом.
chat-emote-msg-click = клацает
chat-emote-msg-clap-single = хлопает { POSS-ADJ($entity) } руками.
...
chat-emote-msg-snarl = оскаливается.
