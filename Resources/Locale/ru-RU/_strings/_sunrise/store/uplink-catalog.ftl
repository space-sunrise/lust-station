...
uplink-scram-implanter-proto-desc = Имплант с й зарядом и огромной перезарядкой в 15 минут. Телепортирует вас в крупном радиусе, пытается перенести на свободную клетку, иногда может сбоить. Он точно безопасен?
