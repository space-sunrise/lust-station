...
ent-BookEngineersHandbook = Справочник инженера
    .desc = Справочник по инженерному делу, подготовленный Qillu.
ent-BookScientistsGuidebook = Справочник учёного
    .desc = Путеводитель по миру науки, подготовленный Qillu.
ent-BookSecurity = Безопасность 101
    .desc = Книга о безопасности на станции, подготовленная Qillu. Книга испачкана кровью. Похоже, что её больше использовали как оружие, чем как учебное пособие.
ent-HyperLinkBookCorporateLaw = Корпоративный Закон
    .desc = Корпоративный закон (КЗ) — свод требований корпорации Qillu ко всем разумным существам на территории объектов корпорации.
