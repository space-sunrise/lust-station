...
ent-ClothingHeadHelmetHardsuitMedicalArrows = PMC "Arrows" Medic Helmet
    .desc = A tactical sealed module with a panoramic visor, built-in diagnostic system (thermal imager, vital signs scanner) and a sterile voice filter. Its white body with the "Rod and Arrow" emblem on the forehead provides instant identification in any conditions.
ent-ClothingHeadHelmetArrowsMedicLeader = PMC "Arrows" medic leader helmet
    .desc = A tactical sealed module with a panoramic visor, built-in diagnostic system (thermal imager, vital signs scanner) and a sterile voice filter. Its white body with the "Rod and Arrow" emblem on the forehead provides instant identification in any conditions. Additional markings on the back and a command headset with a tactical communication channel emphasize the wearer's leadership status.
ent-ClothingOuterHardsuitArrowsMedicLeader = PMC "Arrows" medic squad commander hardsuit
    .desc = A specialized combat medical-evacuation commander's kit. The green elastic sealed undersuit provides basic protection and sterility, while the detachable heavy armor plate with the red-and-white "Rod and Arrow" emblem ensures survivability in the direct fire zone. Yellow signal strips on the limbs allow identification of the medic in the smoke and chaos of battle.
ent-ClothingOuterHardsuitMedArrows = PMC "Arrows" Medic Hardsuit
    .desc = A specialized combat medical-evacuation suit. A green elastic sealed undersuit provides basic protection and sterility, while a detachable heavy armor plate with a red-and-white "Rod and Arrow" emblem ensures survivability under direct fire. Yellow signal tape on the limbs allows identification of the medic in the smoke and chaos of battle.
...
ent-MobHumanArrowsMedic = Medic PMC "Arrows"
ent-MobHumanArrowsMedicLeader = Medic Leader PMC "Arrows"
ghost-role-information-arrow-medic-name = Medic PMC "Arrows"
ghost-role-information-arrow-medic-description = "Medic of the Arrows Elite Extermination Unit"
ghost-role-information-arrow-medic-leader-name = Medic Leader PMC "Arrows"
ghost-role-information-arrow-medic-leader-description = "Chief medic of the Arrows Elite Extermination Unit"
...
ent-ClothingBeltMedicalMT = "Trauma Team" combat belt
    .desc = A tactical modular load-bearing belt made of durable green-black nylon with contrasting yellow inserts. It features quick-release pouches for essential medications (hemostatics, adrenaline, antidotes), tools (tourniquets, scissors, forceps), and primary stabilization supplies.
...
ent-ClothingBackpackDuffelMedArrows = arrows medic backpack
    .desc = A tactical modular medical complex in the style of a PMC. Made of durable green-black camouflage fabric with the "Rod and Arrow" emblem. Equipped with a quick-access compartment system, a built-in refrigeration module for medications, and a deployable sterile field for emergency interventions.
...
job-name-leaderarrows = Netrunner «PMC Arrows»
job-description-leaderarrows = A cold-blooded tactician whose mind is the squad's primary weapon.
job-name-soldierarrows = Soldier «PMC Arrows»
job-description-soldierarrows = A simple and reliable soldier for whom the commander's order is law.
